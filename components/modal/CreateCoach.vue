                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.firstname?.$errors[0]?.$message.toString()" />
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.lastname?.$errors[0]?.$message.toString()" />
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.birthdate?.$errors[0]?.$message.toString()" />
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.birth_place?.$errors[0]?.$message.toString()" />
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.contact_no?.$errors[0]?.$message.toString()" />
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.religion_id?.$errors[0]?.$message.toString()" />
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.occupation?.$errors[0]?.$message.toString()" />
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <FormError :error="x$?.form.sports_team?.$errors[0]?.$message.toString()" />
