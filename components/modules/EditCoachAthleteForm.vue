...
const state = reactive({
    form: {
        ...
        middlename: (props.data.middlename != 'null') ? props.data.middlename : null,
        ...
        religion_id: props.data.religion_id,
        school_id: props.data.school_id,
        occupation: props.data.occupation,
        sports_team: props.data.sports_team,
        photo: null as any,
        registry_date: props.data.registry_date,
    },
    error: null as any,
    option: {
        civil_status: [
