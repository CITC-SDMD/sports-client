        ...
        <transition enter-active-class="transition ease-out duration-100"
            ...
            <MenuItems :class="[
                ...
                <div class="py-1">
                    ...
                    <a @click="goToViewDocuementPage(props.uuid)"
                        ...
                        <DocumentIcon :class="[active ? 'text-blue-500' : '', 'mr-3 size-5']" aria-hidden="true" />
                        View Documents
                    </a>
                    </MenuItem>
                </div>
...
function goToViewDocuementPage(data) {

    if (path === `/events/${uuid}/athletes`) {
        navigateTo(`${path}/${data}/documents`)
    }
}
</script>